	...
	class Admin_newOrdersView {
		public function render($data) {
			...
			if ($results->num_rows == 0 || !$ordersAmount) {
				$html = "<div class='info'>Aktualnie nie ma nowych zamówień.</div>";
			}
			else {
					...
					$html .= "<tbody>";
						while ($row = $results->fetch_array(MYSQLI_ASSOC)) {
							...
							$html .= "<tr>";
								...
								$html .= "<td class='admin-newOrder-state'><a href='{$cfg["path"]}/admin/acceptOrder/$order_id' class='link'>Zatwierdź</a></td>";
							$html .= "</tr>";
